...
<body class="dashboard-page">
						...
						<div style="height: 40px;">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									</span> <input type="text" id="t_user_name" class="form-control1" >
								</div>
							</div>
							<div class="col-sm-1">
						...
						<div style="height: 40px;">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									</span> <input type="text" id="t_pass_word"
										class="form-control1" >
								</div>
							</div>
							<div class="col-sm-1">
							...
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
									 ...
									 <select id="t_is_disable" style="height: 40px;" class="form-control">
					                      <option value="0">启用</option>
					                      <option value="1">禁用</option>
			                   		 </select>
								</div>
    ...
    <script src="${pageContext.request.contextPath}/javascript/adminList.js"></script>
