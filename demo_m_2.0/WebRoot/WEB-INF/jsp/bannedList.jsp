...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">
			    <button class="btn btn-default" >封号设置</button>
				...
				<div class="modal-content">
					...
					<input type="hidden" id="t_id">
						<div style="height: 40px;">
							<label class="col-md-2 control-label">封号次数:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-user"></i>
									</span> <input type="text" id="t_count" class="form-control1" placeholder="请输入封号次数."	onfocus="on_focus('t_count', '请输入封号次数.')" onblur="on_blur('t_count')">
								</div>
							</div>
							<div class="col-sm-2" id="t_count_validate">
						...
						<div style="height: 40px;">
							...
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-user"></i>
									</span> <input type="text" id="t_hours" class="form-control1" placeholder="请输入封号时间,分钟请输入小数，永久封号请输入0"
									onfocus="on_focus('t_hours', '请输入封号时间(如:6分钟请输入0.1).')" onblur="on_blur('t_hours')" >
								</div>
							</div>
							<div class="col-sm-2" id="t_hours_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
    ...
    <script src="${pageContext.request.contextPath}/javascript/bannedList.js"></script>
