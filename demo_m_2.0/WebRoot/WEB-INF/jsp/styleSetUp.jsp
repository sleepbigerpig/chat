...
<body class="dashboard-page">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div style="height: 40px;">
							<label class="col-md-2 control-label">风格名称:</label>
							<div class="col-md-8">
								<div class="input-group input-icon right">
									<span class="input-group-addon">
										<i class="glyphicon glyphicon-star"></i>
									</span>
									 <input type="text" id="t_style_name"
										class="form-control1" placeholder="请输风格名称." onfocus="on_focus('t_style_name','请输风格名称.')" onblur="on_blur('t_style_name')">
								</div>
							</div>
							<div class="col-sm-2" id="t_style_name_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
						<div style="height: 40px;">
							<label class="col-md-2 control-label">风格标示:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="glyphicon glyphicon-time"></i>
									</span>
									<input type="text" id="t_mark"
										class="form-control1" placeholder="请输风格标示." onfocus="on_focus('t_mark','请输风格标示.')" onblur="on_blur('t_mark')">
								</div>
							</div>
							<div class="col-sm-2" id="t_mark_validate">
								<p class="help-block" style="color: red;">*</p>
							</div>
						</div>
						</br>
						<div class="form-group" style="height: 40px;">
							...
							<div class="col-md-8">
								<div class="input-group input-icon right">
									...
									</span> <select id="t_state" style="height: 40px;" class="form-control">
	...
	<script src="${pageContext.request.contextPath}/javascript/styleSetUp.js"></script>
