...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">
			    <button class="btn btn-default">消费记录</button>
			    <div style="float: right;width: 55%">
				    <button class="btn btn-default" style="float: left;">消费类型:</button>
				    <select id="type"  style="width: 200px;float: left;margin-right: 1%;height: 36px;" onchange="on_change();" class="form-control">
	                      <option value="0">全部类型</option>
	                      <option value="1">聊天消费</option>
	                      <option value="2">视频消费</option>
	                      <option value="3">私密照片</option>
	                      <option value="4">私密视频</option>
	                      <option value="5">查看手机</option>
	                      <option value="6">查看微信</option>
	                      <option value="7">赠送红包</option>
	                      <option value="8">开通VIP</option>
	                      <option value="9">赠送礼物</option>
					</select>
    ...
    <script src="${pageContext.request.contextPath}/javascript/consumeList.js"></script>
