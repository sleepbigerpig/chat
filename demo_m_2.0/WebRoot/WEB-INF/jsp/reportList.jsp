...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">
			    <button class="btn btn-default" >举报列表</button>
			    <div style="float: right;width: 54%">
				    <button class="btn btn-default" style="float: left;">条件:</button>
				 	<input type="text" class="form-control" id="condition" style="height: 36px; float: left;width: 200px;margin-right: 2%"  placeholder="请输入昵称或内容.">
			...
			<div class="modal-dialog" style="width: 35%;">
				<div class="modal-content">
						...
						<div style="height: 80px;">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<textarea id="t_handle_comment" name="t_handle_comment" class="form-control"
								     	rows="4" placeholder="Enter ...">
								     </textarea>
								</div>
							</div>
							<div class="col-sm-1">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" onclick="on_click_handle_report();">
    ...
    <script src="${pageContext.request.contextPath}/javascript/reportList.js"></script>
