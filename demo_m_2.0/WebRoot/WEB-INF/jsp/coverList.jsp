...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			<div class="agile-grids">
			    <button class="btn btn-default">封面列表</button>
			    <div style="float: right;width: 18%">
					<button class="btn btn-default" style="float: left;">条件:</button>
					<input type="text" class="form-control" id="condition" style="height: 36px; float: left;width: 200px;margin-right: 2%"  placeholder="请输入用户昵称.">
						...
						<div>
							<div class="agile-gallery-grid">
								<div class="agile-gallery">
								   <img id="hand_img" src="${pageContext.request.contextPath }/images/g4.jpg" alt="" width="85%"/>
								</div>
							</div>
						</div>
						</br>
    ...
    <script src="${pageContext.request.contextPath}/javascript/coverScript.js"></script>
</body>
</html>
