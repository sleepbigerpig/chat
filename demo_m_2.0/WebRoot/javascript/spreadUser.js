...
function ajax_load_table(){
    ...
    $('#utable').bootstrapTable({
        url: path+"admin/getInviteUserList.htm",
        method: 'post',
        ...
        columns: [
              	...
              	},
              	{
              		...
              		formatter:function(value,row,index){
              			//指定推送弹窗
              			return '<a href="javascript:on_click_totalTime('+row.t_id+');" class="btn btn-default" style="height: 25px;line-height: 0.5;background-color: #87CEFA;">明细</a>';
              		}
              	}
        ]
    });
